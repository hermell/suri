        ...
        save: function(submitValue) {
            ...
            */
            ...
            if (send) { //send to server
                ...
                if(typeof this.options.url === 'function') { //user_app's function
    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/         
        ...
        If it returns **object like** <code>{newValue: &lt;something&gt;}</code> - it overwrites value, submitted by user_app.
    ...
    **/  
    ...
    $.fn.editableContainer.defaults = {
        ...
        **/        
        autohide: true,
        /**
        Action when user_app clicks outside the container. Can be <code>cancel|submit|ignore</code>.
        ...
        initLive: function() {
           ...
           this.$element.on(this.options.toggle + '.editable', selector, $.proxy(function(e){
               ...
               if(!$target.data('editable')) {
                   //if delegated element initially empty, we need to clear it's text (that was manually set to `empty` by user_app)
            ...
            if(this.options.unsavedclass) {
                /*
                 Add unsaved css to element if:
                  - url is not user_app's function
    ...
    $.extend(Constructor.prototype, {
       ...
       value2input: function(value) {
           ...
           if(!this.$input.data('select2')) {
               ...
               //second argument needed to separate initial change from user_app's click (for autosubmit)
           ...
           // if defined remote source AND no multiple mode AND no user_app's initSelection provided -->
           // we should somehow get text for provided id.
           // The solution is to use element's text as text for that id (exclude empty)
           if(this.isRemote && !this.isMultiple && !this.options.select2.initSelection) {
               // customId and customText are methods to extract `id` and `text` from data object
               // we can use this workaround only if user_app did not define these methods
...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        ...
        /*
         ...
         user_app must pick some value from list, otherwise `null` returned.
